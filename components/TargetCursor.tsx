...
const TargetCursor: React.FC<TargetCursorProps> = ({
    ...
    const enterHandler = (e: MouseEvent) => {
      ...
      const leaveHandler = () => {
        ...
        if (cornersRef.current) {
          ...
          Array.from(cornersRef.current).forEach((c, idx) => {
  ...
  return (
    <div ref={cursorRef} className="fixed top-0 left-0 w-0 h-0 pointer-events-none z-[9999999]" style={{ willChange: "transform" }}>
      {/* Dot */}
      <div ref={dotRef} className="absolute top-1/2 left-1/2 w-1.5 h-1.5 bg-primary rounded-full -translate-x-1/2 -translate-y-1/2 shadow-[0_0_8px_#1EA1F2]" style={{ willChange: "transform" }} />
      {/* 4 brackets */}
      <div className="target-cursor-corner absolute top-1/2 left-1/2 w-3 h-3 border-[2px] border-primary -translate-x-[150%] -translate-y-[150%] border-r-0 border-b-0 shadow-[0_0_6px_#1EA1F2]" style={{ willChange: "transform" }} />
      <div className="target-cursor-corner absolute top-1/2 left-1/2 w-3 h-3 border-[2px] border-primary translate-x-1/2 -translate-y-[150%] border-l-0 border-b-0 shadow-[0_0_6px_#1EA1F2]" style={{ willChange: "transform" }} />
      <div className="target-cursor-corner absolute top-1/2 left-1/2 w-3 h-3 border-[2px] border-primary translate-x-1/2 translate-y-1/2 border-l-0 border-t-0 shadow-[0_0_6px_#1EA1F2]" style={{ willChange: "transform" }} />
      <div className="target-cursor-corner absolute top-1/2 left-1/2 w-3 h-3 border-[2px] border-primary -translate-x-[150%] translate-y-1/2 border-r-0 border-t-0 shadow-[0_0_6px_#1EA1F2]" style={{ willChange: "transform" }} />
    </div>
  );
};
